...
export default class FocuseImage extends Component{
    constructor(props) {
        super(props);
        this.state = {
            images : [
                <Image source={require('../../img/bn1.jpg')} />,
                <Image source={require('../../img/bn2.jpg')} />,
                <Image source={require('../../img/bn3.jpg')} />,
                <Image source={require('../../img/bn4.jpg')} />,
            ],
