      ...
      <View style={styles.container}>
        ...
        <KeyboardAwareScrollView style={styles.logForm}>
          <View style={styles.inputForm}>
            ...
            <TextInput ref="userInput" onChangeText={(newText) => this._ableClear(newText)} style={[styles.inputText, { width: Width * 0.8 - 90 }]} placeholder="请输入账号" />
            <TouchableOpacity onPress={this._clearInput.bind(this)} disabled={!this.state.clearAble} style={styles.clear}>
              <Text style={{ fontSize: 14, color: this.state.clearAble ? "black" : "gray" }}>清空</Text>
            </TouchableOpacity>
          </View>
          <View style={styles.inputForm}>
            <Image resizeMode='stretch' source={require("../../img/login-pwd.png")} style={styles.iconImg} />
            <TextInput keyboardType={"numbers-and-punctuation"} style={[styles.inputText, { width: Width * 0.8 - 90 }]} placeholder="请输入密码" secureTextEntry={this.state.securityPwd} />
            {
